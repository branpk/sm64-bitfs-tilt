...
u16 randomU16(void);
s32 randomUnit();
v3f **setV3f(v3f *dst, f32 x, f32 y, f32 z);
v3f **copyV3f(v3f *dst, v3f *src);
v3h **copyV3h(v3h *dst, v3h *src);
v3h **setV3h(v3h *v, s16 x, s16 y, s16 z);
v3f **v3hToV3f(v3f *dst, v3h *src);
v3f **crossProduct(v3f *dst, v3f *a, v3f *b);
